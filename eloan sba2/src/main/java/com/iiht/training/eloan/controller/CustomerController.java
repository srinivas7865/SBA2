...
public class CustomerController {
	...
	public ResponseEntity<LoanOutputDto> getStatus(@PathVariable Long loanAppId,BindingResult result){
		return null;
	}
	
	@GetMapping("/loan-status-all/{customerId}")
	public ResponseEntity<List<LoanOutputDto>> getStatusAll(@PathVariable Long customerId,BindingResult result){
